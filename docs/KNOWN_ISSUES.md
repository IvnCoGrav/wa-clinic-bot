...
- **Gejala live:** koordinat/jarak/ongkir customer hanya berubah setelah admin menekan "Refresh & Hitung Ulang" (Bunda Agatha `6285728800224`: GPS pin 25 Sep 13:39:36, tersimpan baru 26 Sep 01:34:24 via refresh manual + 01:35:26 staff).
...
- **Implementasi (2026-09-26):**
  ...
  - **Sisa:** uji shareloc live di kontak sandbox internal (`6289999*`, `is_sandbox_test=true`) — butuh kirim GPS pin nyata (WAHA→webhook) atau inject webhook bertanda tangan (`WAHA_WEBHOOK_SECRET` set). Menunggu keputusan user (1-step vs 2-step, gate Meta).
- **Status:** IN PROGRESS — Fase 0-4 SELESAI + deploy Fase 5 SELESAI (2026-09-26); uji shareloc live sandbox menyusul.
