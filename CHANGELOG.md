...
- **Regression**: `npm run build` + `tsc` dashboard exit 0, 6 file fase + 40 tests terkait hijau; full suite 284 passed / 31 pre-existing failures di luar cakupan fase (queue/telemetry/typing-transport/v3-governance stubs).
