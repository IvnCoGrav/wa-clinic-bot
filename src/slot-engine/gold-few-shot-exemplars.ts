 ...
 * 3. Sesuai Aturan Emas V3: jadwal/hari kunjungan ditetapkan Admin CS,
 *    bot tidak menanyakan pilihan jam pagi/siang/sore. Format tebal
 *    harga konsisten *Rp ...*. Satu pertanyaan penutup per balasan.
...
export const GOLD_FEW_SHOT_EXEMPLARS: FewShotExemplar[] = [
  {
    ...
    tags: ['sapaan', 'salam', 'assalamualaikum', 'islami'],
  ...
  },
  {
    ...
    tags: ['jam_operasional', 'jam', 'operasional', 'buka', 'tutup', 'batas', 'malam'],
  ...
  },
  {
    ...
    scenario: 'Customer menanyakan ketersediaan slot/jadwal terdekat (cek dulu ke Admin CS)',
    tags: ['ask_schedule', 'jadwal', 'slot', 'ketersediaan', 'hari', 'cek'],
    customerMessage: 'Kak, jadwal terdekat yang masih kosong kapan ya?',
    idealResponse:
      'Baik Bunda, untuk ketersediaan jadwal akan kami bantu cekkan dulu slot Bidan yang kosong ya 🙏 Nanti hari dan jam kunjungannya kami infokan setelah Admin CS kami pastikan. Rencana Bunda ingin treatment di hari apa? 🤗',
    isActive: true,
    sortOrder: 12,
  },
  {
    ...
    tags: ['ask_schedule', 'jadwal', 'penuh', 'full', 'ganti_hari', 'reschedule'],
  ...
  },
  {
    ...
    tags: ['ask_price', 'harga', 'tarif', 'biaya', 'pricelist'],
  ...
  },
  {
    ...
    tags: ['promo', 'diskon', 'potongan', 'promosi'],
  ...
  },
  {
    ...
    tags: ['payment', 'qris', 'transfer', 'cash', 'tunai', 'bayar', 'bca', 'mandiri', 'bri'],
  ...
  },
  {
    ...
    tags: ['bidan', 'str', 'sertifikat', 'terapis', 'kualifikasi', 'resmi', 'legalitas'],
  ...
  },
  {
    ...
    tags: ['higienis', 'steril', 'bersih', 'alat', 'aman', 'kebersihan'],
  ...
  },
  {
    ...
    tags: ['vaksin', 'imunisasi', 'pasca_vaksin', 'konsultasi', 'demam', 'kia'],
  ...
  },
  {
    ...
    tags: ['rewel', 'susah_tidur', 'tidur', 'konsultasi', 'tenang', 'adaptasi'],
    customerMessage:
  ...
  },
  {
    ...
    tags: ['konsultasi', 'pencernaan', 'bab', 'diare', 'asi', 'ibu', 'gejala'],
    customerMessage:
  ...
  },
  {
    ...
    tags: ['laktasi', 'asi', 'menyusui', 'ibu', 'nifas', 'perawatan_ibu'],
  ...
  },
  {
    ...
    tags: ['newborn', 'selapan', 'cukur', 'bayi_baru_lahir', 'perawatan_bayi', 'usia'],
  ...
  },
  {
    ...
    tags: ['kids', 'balita', 'anak', 'kids_spa', 'usia', 'perawatan_anak'],
  ...
  },
  {
    ...
    tags: ['tidak_tersedia', 'belum_ada', 'cuci_hidung', 'layanan_luar', 'tolak', 'eskalasi'],
  ...
  },
  {
    ...
    tags: ['batal', 'cancel', 'menunda', 'tidak_papa', 'follow_up', 'penundaan'],
  ...
  },
  {
    ...
    tags: ['afirmasi', 'konfirmasi', 'keep', 'setuju', 'booking', 'follow_up'],
  ...
  },
  {
    ...
    tags: ['ubah', 'ganti', 'treatment', 'konfirmasi', 'follow_up', 'pilihan'],
  ...
  },
  {
    ...
    tags: ['rekomendasi', 'pilih', 'bingung', 'treatment', 'saran'],
  ...
  },
  {
    ...
    tags: ['feedback', 'testimoni', 'terima_kasih', 'follow_up', 'senang'],
    customerMessage:
  ...
  },
  {
    ...
    tags: ['terima_kasih', 'makasih', 'tutup', 'sopan', 'salam'],
