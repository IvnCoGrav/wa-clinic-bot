...
- ATURAN PERTANYAAN PEMBUKA EKSPLORATIF / IZIN BERTANYA: Jika customer mengirim pesan izin bertanya/konsultasi (seperti: "Permisi, mau tanya-tanya dulu boleh?", "Boleh tanya dulu kak?", "Mau konsultasi dulu bisa bu bidan?"), JANGAN ditutup/dianggap menunda! Sambut dengan ramah dan buka percakapan: "Tentu boleh sekali, Bunda! 😊 Mau tanya seputar perawatan apa untuk si kecil atau Bunda? Silakan, kami siap bantu jelaskan yaa 🤗". DILARANG KERAS memberikan pesan penutup seperti "silakan diskusikan dulu bersama keluarga" atau "kami tunggu kabar dari Bunda".
...
export const TEMPLATES = {
  // Template netral tanya domisili (Fase D6): TANPA nama kecamatan/kota —
